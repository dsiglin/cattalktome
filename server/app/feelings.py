...
def _flat_ears(g: FaceGeometry) -> float:
    """0..1: how far the ears' base angle has swept back from upright.
    Larger |angle| -> flatter/back-swept -> higher score."""
    avg = (abs(g.left_ear_angle_deg) + abs(g.right_ear_angle_deg)) / 2
    return _clamp01(avg / 60.0)
...
FEELINGS: List[Feeling] = [
    Feeling(
        ...
        score=lambda g, p: _blend((3, p.brightness), (2, 1 - p.contrast), (2, 1 - p.sharpness), (2, _forward_ears(g))),
    ),
    Feeling(
        ...
        score=lambda g, p: _blend((3, 1 - p.sharpness), (2, 1 - p.contrast), (2, _near(p.brightness, 0.32, 0.35)), (1.5, _forward_ears(g))),
    ),
    Feeling(
        ...
        score=lambda g, p: _blend((3, p.sharpness), (2.5, _forward_ears(g)), (2, 1 - _low_head(g)), (1.5, p.contrast)),
    ),
    Feeling(
        ...
        score=lambda g, p: _blend((3, p.sharpness), (2, p.brightness), (2, _wide_splay(g)), (2, _forward_ears(g))),
    ),
    Feeling(
        ...
        score=lambda g, p: _blend((2.5, p.dark_ratio), (2.5, p.contrast), (2.5, _flat_ears(g)), (1.5, p.sharpness)),
    ),
    Feeling(
    ...
    Feeling(
        ...
        score=lambda g, p: _blend((3, g.nose_symmetry), (2.5, _forward_ears(g)), (2, _near(p.brightness, 0.6, 0.35)), (1, p.sharpness)),
    ),
    Feeling(
        ...
        score=lambda g, p: _blend((3, 1 - p.contrast), (2, 1 - p.sharpness), (2.5, _relaxed_muzzle(g)), (1.5, _forward_ears(g))),
    ),
    Feeling(
        ...
        score=lambda g, p: _blend((3, 1 - _low_head(g)), (2, _near(p.contrast, 0.5, 0.35)), (2, _near(p.sharpness, 0.45, 0.35)), (1.5, g.nose_symmetry)),
    ),
    Feeling(
        ...
        score=lambda g, p: _blend((2.5, p.sharpness), (2, _wide_splay(g)), (2, _tight_muzzle(g)), (2, _forward_ears(g))),
    ),
]
